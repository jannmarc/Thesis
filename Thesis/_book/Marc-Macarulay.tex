...
Gender was grouped categorically and included: Female, Male, Multiple
and Unknown.
...
reported in categorically in the descriptive analyses for a simpler
layout.
...
assistance status. This is appropriate for this study because logistic
reregression analyses allows for analyzing the association of an effect
to a binomial response variable by combining multiple variables to avoid
confounding ({\textbf{???}}).
...
This version of the thesis was generated on 2020-05-19 00:15:21. The
