...
lead to potentially life-threatening complications. Insulin is produced
in the pancreas and is the key regulatory hormone of glucose. The
...
disease condition is called Diabetes Mellitus and has multiple types.

\subsection{Type 1 Diabetes}\label{type-1-diabetes}

Type 1 diabetes is a loss of insulin caused by the destruction of cells
in the pancreas at the hands of the body's own immune system. The
life-long condition is typically diagnosed relatively early in life, and
is treated by monitoring sugar levels, adjusting diet, and maintaining
insulin levels through regular injections

\subsection{Type 2 Diabetes}\label{type-2-diabetes}
...
This version of the thesis was generated on 2020-05-10 21:44:46. The
