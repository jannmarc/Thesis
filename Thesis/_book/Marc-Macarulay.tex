...
Edwards, Essien, \& Baggett, 2018 ; Thomson et al., 2013). The
government tries to ameliorate housing problems by providing public
housing, which are decent and safe subsidized rental housing for
eligible populations including low-income families, the elderly, and
persons with disabilities (HUD, 2020). However, the relationship between
public housing and health is minimally explored. Some relevant studies
have shown that public housing residents have worse health outcomes than
other city residents (Digenis-Bury, Brooks, Chen, Ostrem, \& Horsburgh,
2008 ; Manjarrez, Popkin, \& Guernsey, 2007). Even less understood is
how public housing assistance impacts chronic health conditions like
diabetes.
...
reduce diabetes management self-efficacy for low income adults
...
diabetes status. For this reason, the current study aimed to explore
...
Seattle Housing Authority (SHA). This partnership enabled data to be
...
collaboration revolving around health and public housing. This research
aims to use the provided data to contribute to the literature on the
association between public housing and diabetes among Medicaid and
Medicare patients. The findings of the study could help identify where
resources for diabetes prevention and management might be used more
effectively.
...
King County area. While SHA predominatly focuses on the greater Seattle
area, with nearly 35,000 people scattered throughout 400 sites across
the city.
...
enrollment for families and individuals. Claims and enrollment data for
Medicaid and Medicare were from PHSKC which was provided by Washington
Health Care Authority (HCA). Enrollment data contained information on
who was receiving health insurance benefits. Claims data provided
elements such as diagnosis codes and these were used to identify acute
events and chronic conditions. The separated health and housing data
sources were linked together by a unique identifier ID. Further detail
on the process of joinging data can be found in the King County Data
Across Sectors for Housing and Health, 2018 Report (Public Health -
...
coverage restriction provides a more accurate representation of
participants with full Medicaid and Medicare insurance benefits rather
than people with partial benefits. The overall number of participants
derived from the DASHH dataset totaled 585,372.
...
category. Whereas those responses that contained any of the 3 types of
housing assistance was categorized into the PHA group.
...
variable was dichotomous, given a 0 or 1. Those that did meet the CCW
algorithm were coded into the diabetes group and those that met the
criteria were categorized into the diabetes group.
...
the demographic categorical variables. The demographics table is
arranged by PHA status, this included: KCHA, SHA, combined PHA and
non-PHA. Although the discrete variable for age was used in the
statistical analyses, age was reported categorically in the descriptive
analyses for a simpler distribution description. Mean and median age
were also shown for each category.
...
There were two main statistical analyses performed in this study, the
relationship between public housing and diabetes as well as the
relationship between each of the individual public housing authorities
and diabetes. The distinction between these analyses are that first
provides the likelihood of meeting the diabetes definiton if a person
was receiving public housing assistance and the second provides a more
specific estimate for each of the housing authority.

Two models were used to determine the odds ratios (OR) and corresponding
...
In addition, these models were also fit to determine the odds ratio of
diabetes status in relation to the seperate public housing authoritys.
...
potential confounders (age, gender, race and ethnicity) the results
indicate that the effect of public housing on diabetes status increased
even greater. The findings also suggest that when stratified into PHA
agency, meaning when separted into KCHA or SHA, the initial crude model
showed that KCHA residents where were less likely to meet the definition
of diabetes than SHA residents but still more likely than the non-PHA
group. However, after adjust for potential confounders, the effect of
association between PHA agency on diabetes status saw a greater increase
for KCHA residents than SHA residents.
...
the obtained data, these elements were not available thus not accounted
in this study.
...
services for diabetes care or diabetes related outcomes. People who may
have been diabetic during this period but were asymptomatic or those who
had been previously diagnosed with diabetes but did not seek care within
the time frame provided by the CCW algorithm definition of diabetes were
not captured in the study. Consequently, the eligible population in this
