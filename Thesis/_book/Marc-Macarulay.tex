...
(Digenis-Bury, Brooks, Chen, Ostrem, \& Horsburgh, 2008, and
@Manjarrez2007). Even less understood is the relationship between public
housing and chronic health conditions like diabetes.
...
also have a higher prevalence of obesity and diabetes ({\textbf{???}}).
...
({\textbf{???}}). Considering the population demographics in the PHA
group, another successful strategy may be to implement a culturally
competent diabetes care intervention program ({\textbf{???}}).
...
participants to afford diabetes-related financial expenses
({\textbf{???}}). Additionally, when housing needs are met participants
are able to prioritize diabetes self-management, avoiding potential
complications (Keene, Guo, \& Murillo, 2018). Those participants with
diabetes prior to receiving public housing assistance could potentially
see a reduction in diabetes related complications over time.
