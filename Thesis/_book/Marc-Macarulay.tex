...
Overall, 9.9\% were considered to have diabetes and the rest, 90.1\%
were not considered to have diabetes.
\begin{verbatim}
...
\end{tabu}
\end{table}
In the unadjusted model the odds ratio of having diabetes was 1.34 fold
greater (95\% CI: 1.31-1.38) for those with public housing assistance
(table 2).
...
\caption{\label{tab:unnamed-chunk-4}Population Demographics}
\centering
\begin{tabu} to \linewidth {>{\raggedright\arraybackslash}p{6.1cm}>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X}
\toprule
X1 & KCHA & SHA & Combined PHA & Non-PHA\\
...
This version of the thesis was generated on 2020-05-21 16:04:41. The
