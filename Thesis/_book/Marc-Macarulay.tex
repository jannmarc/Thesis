...
Ostrem, \& Horsburgh, 2008 \& Manjarrez, Popkin, \& Guernsey (2007)).
Even less understood is the relationship between public housing and
...
within the last 2 years{[}@{]}. This definition does not specify
diabetes variant but instead accounts for any type diabetes diagnoses.
The diabetes status outcome variable was dichotomous, given a 0 or 1.
Those that did not meet the CCW alogrithm were coded a 0 and those that
met the criteria were coded as 1 for diabetes status.
