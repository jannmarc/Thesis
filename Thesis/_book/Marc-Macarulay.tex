...
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\DataTypeTok{format =} \StringTok{"latex"}\NormalTok{, }\DataTypeTok{caption=} \StringTok{"Population Demographics"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\begin{table}
