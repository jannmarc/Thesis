...
Among the study participants, the proportion of people in the PHA group
were 10.4\% and of that, 5.9\% were with KCHA and 4.6\% with SHA. The
majority, 89.5\% did not have any public housing assitance in 2017.
Overall, 9.9\% were considered to meet the definiton of diabetes and the
rest, 90.1\% were not considered to have diabetes.
\begin{table}
...
residents were 63\% more likely to meet the definition of diabetes
...
\midrule
\endhead
Non-PHA & 1 & 1\tabularnewline
PHA & 1.34 (1.31-1.38) & 1.92 (1.58-2.45)\tabularnewline
\bottomrule
\end{longtable}
...
odds of meeting the definiton of diabetes were 1.28 times greater (95\%
CI: 1.24-1.33) among KCHA residents and 1.42 (95\% CI: 1.38-1.48) times
...
\caption{\label{tab:unnamed-chunk-3}Population Demographics}
\centering
\begin{tabu} to \linewidth {>{\raggedright\arraybackslash}p{6.1cm}>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X}
\toprule
Characteristics & KCHA & SHA & Combined PHA & Non-PHA\\
...
This version of the thesis was generated on 2020-05-23 19:37:28. The
