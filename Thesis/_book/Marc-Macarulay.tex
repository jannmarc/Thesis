...
SHA (See \ref{tab:table1}). The majority of the study participants,
...
\caption{\label{tab:unnamed-chunk-1}Crude PHA Regression Model}
\centering
\fontsize{12}{14}\selectfont
...
\caption{\label{tab:unnamed-chunk-2}Adjusted PHA Regression Model}
\centering
\fontsize{12}{14}\selectfont
\begin{tabu} to \linewidth {>{\raggedright}X>{\raggedleft}X>{\raggedleft}X>{\raggedright}X>{\raggedleft}X>{\raggedleft}X}
\toprule
...
\caption{\label{tab:unnamed-chunk-3}Crude PHA Agency Regression Model}
\centering
\fontsize{12}{14}\selectfont
\begin{tabu} to \linewidth {>{\raggedright}X>{\raggedleft}X>{\raggedleft}X>{\raggedright}X>{\raggedleft}X>{\raggedleft}X}
\toprule
...
\caption{\label{tab:unnamed-chunk-4}Adjusted PHA Agency Regression Model}
\centering
\fontsize{12}{14}\selectfont
\begin{tabu} to \linewidth {>{\raggedright}X>{\raggedleft}X>{\raggedleft}X>{\raggedright}X>{\raggedleft}X>{\raggedleft}X}
\toprule
