...
age was reported in categorically in the descriptive analyses for a simpler layout.

For the statistical analyses, logistic regression models were fitted to assess the risk of diabetes status in relation to public housing assistance status. This is appropriate for this study because logistic reregression analyses allows for analyzing the association of an effect to a binomial response variable by combining multiple variables to avoid confounding [@Sperandei2014].
