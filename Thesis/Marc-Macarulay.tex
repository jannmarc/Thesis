...
\centering
\begin{tabu} to \linewidth {>{\raggedright\arraybackslash}p{6.1cm}>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X}{>{\raggedright\arraybackslash}p{6.1cm}llll}
\toprule
...
This version of the thesis was generated on 2020-05-23 20:54:17. The
