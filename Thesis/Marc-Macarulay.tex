...
participants, 89.5\% did not have any public housing assistance in 2017.
...
to meet the definition of diabetes and the rest, 90.1\% were not
...
\caption{\label{tab:unnamed-chunk-1}PHA}
...
\caption{\label{tab:unnamed-chunk-1}PHA_A}
\fontsize{12}{14}\selectfont
\begin{tabular}[t]{lll}
\toprule
Housing Status & Model 1 & Model 2\\
...
odds of meeting the definition of diabetes were 1.28 times greater among
...
causal relationship. As previously mentioned, substandard and unstable
...
subsequently reducing the impact of information bias. \#\# Limitations
