...
\bottomrule
\end{longtable}
Table: \label{tab:PHA} Association between PHA Status and Diabetes
\begin{tablenotes}
     \small
...
\begin{longtable}[]{@{}lll@{}}
\toprule
Status & Unadjusted & Adjusted*\tabularnewline
\midrule
\endhead
Non-PHA & Referent & Referent\tabularnewline
...
\bottomrule
\end{longtable}
Table: \label{tab:PHAA} Association between the Public Housing Authorities
and Diabetes\\
\begin{tablenotes}
     \small
     \item * Adjusted for age, race and ethnicity and gender status
